  ...
  return (
    <section className="bg-mist relative isolate overflow-hidden pt-20 pb-24 text-ink sm:pt-28 sm:pb-32 lg:pt-32 lg:pb-36">
      ...
      <div className="relative mx-auto w-full max-w-[1180px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-ink/15 bg-paper/60 px-3.5 py-1.5 text-xs font-semibold text-ink/75">
        ...
        <div className="mt-8 grid gap-12 lg:grid-cols-12 lg:gap-x-16 lg:items-start">
          ...
          <div className="lg:col-span-6 lg:pt-2">
            <div className="glass-surface-light soft-surface rounded-[2rem] border border-ink/10 p-7 sm:p-10">
              ...
              <p className="headline mt-3 text-[1.5rem] leading-snug text-ink sm:text-[1.875rem] lg:text-[2rem]">
                Meta superada em <span className="underline decoration-deep/40">20%</span>{" "}
                utilizando aproximadamente <span className="underline decoration-deep/40">70%</span>{" "}
                da verba prevista.
              </p>
            </div>
